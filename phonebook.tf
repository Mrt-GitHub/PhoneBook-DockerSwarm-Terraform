...
locals {
  github-repo = "https://github.com/Mrt-GitHub/PhoneBook-DockerSwarm-Terraform.git"
  github-file-url = "https://raw.githubusercontent.com/Mrt-GitHub/PhoneBook-DockerSwarm-Terraform/master/"
}
